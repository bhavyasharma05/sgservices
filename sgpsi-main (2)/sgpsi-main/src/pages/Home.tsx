...
const Home = () => {
  ...
  const services = [
    ...
    {
      image: '/src/pages/Carpet-Encapsulation-thumb.png',
            ...
            >
              ...
              >
                <div className="flex items-center space-x-4">
                  ...
                  <div>
                    <div className="font-semibold text-gray-900">500+ Services</div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            {services.map((service, index) => (
              ...
              >
                <motion.div 
                  className="group bg-white p-8 rounded-lg shadow-lg hover:shadow-xl transition-all duration-300 border border-gray-100 cursor-pointer"
                  variants={itemVariants}
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          >
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              ...
              <Link 
                to="/get-quote"
                className="border-2 border-red-600 text-red-600 px-8 py-4 rounded-md hover:bg-red-600 hover:text-white transition-all duration-300 font-semibold transform hover:-translate-y-1"
              >
                Get Free Quote
              </Link>
            </div>
